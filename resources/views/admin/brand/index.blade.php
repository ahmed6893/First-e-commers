                            ...
                            <table class="table table-bordered text-nowrap border-bottom" id="basic-datatable">
                                ...
                                @foreach($brands as $brand)
                                    <tr>
                                        ...
                                        <td class="d-flex">
                                            <a href="{{route('brand.edit',$brand->id)}}" class="btn btn-danger me-2">Edit</a>

                                            @if($brand->status=1)
                                                <a href="{{route('brand.show',$brand->id)}}" class="btn btn-success me-2">Inactive</a>
                                            @else
                                                <a href="{{route('brand.show',$brand->id)}}" class="btn btn-warning me-2">Active</a>
                                            @endif
